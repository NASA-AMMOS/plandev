...
import gov.nasa.ammos.plandev.constraints.tree.AccumulatedDuration;
import gov.nasa.ammos.plandev.constraints.tree.ActivitySpan;
import gov.nasa.ammos.plandev.constraints.tree.ActivityWindow;
import gov.nasa.ammos.plandev.constraints.tree.And;
import gov.nasa.ammos.plandev.constraints.tree.AssignGaps;
import gov.nasa.ammos.plandev.constraints.tree.Changes;
import gov.nasa.ammos.plandev.constraints.tree.DiscreteParameter;
...
import gov.nasa.ammos.plandev.constraints.tree.Ends;
import gov.nasa.ammos.plandev.constraints.tree.Equal;
import gov.nasa.ammos.plandev.constraints.tree.Expression;
import gov.nasa.ammos.plandev.constraints.tree.ForEachActivitySpans;
import gov.nasa.ammos.plandev.constraints.tree.ForEachActivityViolations;
import gov.nasa.ammos.plandev.constraints.tree.GreaterThan;
import gov.nasa.ammos.plandev.constraints.tree.GreaterThanOrEqual;
import gov.nasa.ammos.plandev.constraints.tree.KeepTrueSegment;
import gov.nasa.ammos.plandev.constraints.tree.LessThan;
import gov.nasa.ammos.plandev.constraints.tree.LessThanOrEqual;
import gov.nasa.ammos.plandev.constraints.tree.LongerThan;
import gov.nasa.ammos.plandev.constraints.tree.Not;
import gov.nasa.ammos.plandev.constraints.tree.NotEqual;
import gov.nasa.ammos.plandev.constraints.tree.Or;
import gov.nasa.ammos.plandev.constraints.tree.Plus;
import gov.nasa.ammos.plandev.constraints.tree.ProfileExpression;
import gov.nasa.ammos.plandev.constraints.tree.Rate;
import gov.nasa.ammos.plandev.constraints.tree.RealParameter;
import gov.nasa.ammos.plandev.constraints.tree.RealResource;
import gov.nasa.ammos.plandev.constraints.tree.RealValue;
import gov.nasa.ammos.plandev.constraints.tree.RollingThreshold;
import gov.nasa.ammos.plandev.constraints.tree.ShiftBy;
import gov.nasa.ammos.plandev.constraints.tree.ShiftEdges;
import gov.nasa.ammos.plandev.constraints.tree.ShorterThan;
import gov.nasa.ammos.plandev.constraints.tree.SpansConnectTo;
import gov.nasa.ammos.plandev.constraints.tree.SpansContains;
import gov.nasa.ammos.plandev.constraints.tree.SpansFromWindows;
import gov.nasa.ammos.plandev.constraints.tree.SpansSelectWhenTrue;
import gov.nasa.ammos.plandev.constraints.tree.Split;
import gov.nasa.ammos.plandev.constraints.tree.Starts;
import gov.nasa.ammos.plandev.constraints.tree.Times;
import gov.nasa.ammos.plandev.constraints.tree.Transition;
import gov.nasa.ammos.plandev.constraints.tree.ValueAt;
import gov.nasa.ammos.plandev.constraints.tree.ViolationsOfWindows;
import gov.nasa.ammos.plandev.constraints.tree.WindowsFromSpans;
import gov.nasa.ammos.plandev.constraints.tree.WindowsValue;
...
import static gov.nasa.ammos.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.DeficitHull;
import static gov.nasa.ammos.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.DeficitSpans;
import static gov.nasa.ammos.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.ExcessHull;
import static gov.nasa.ammos.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.ExcessSpans;
