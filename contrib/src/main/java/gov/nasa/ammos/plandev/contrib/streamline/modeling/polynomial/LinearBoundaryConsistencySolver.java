...
import static gov.nasa.ammos.plandev.contrib.streamline.core.ErrorCatching.success;
...
import static gov.nasa.ammos.plandev.contrib.streamline.debugging.Naming.getName;
import static gov.nasa.ammos.plandev.contrib.streamline.debugging.Naming.name;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.LinearBoundaryConsistencySolver.GeneralConstraint.constraint;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.LinearBoundaryConsistencySolver.InequalityComparison.GreaterThanOrEquals;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.LinearBoundaryConsistencySolver.InequalityComparison.LessThanOrEquals;
...
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.subtract;
