package gov.nasa.jpl.plandev.contrib.streamline.modeling;

import gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.*;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.monads.UnstructuredResourceApplicative;
...
import gov.nasa.jpl.plandev.contrib.streamline.modeling.linear.Linear;
...
import gov.nasa.jpl.plandev.contrib.streamline.unit_aware.UnitAware;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.Approximation.approximate;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.DifferentiableResources.asDifferentiable;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.DifferentiableResources.divide;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.DivergenceEstimators.byBoundingError;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.IntervalFunctions.byBoundingError;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.IntervalFunctions.byUniformSampling;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.SecantApproximation.ErrorEstimates.errorByOptimization;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.SecantApproximation.ErrorEstimates.errorByQuadraticApproximation;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.SecantApproximation.secantApproximation;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.UnstructuredResources.asUnstructured;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.set;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.toggle;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.using;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.assertThat;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialEffects.consume;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.asPolynomial;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.asUnitAwarePolynomial;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.clamp;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.constant;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.integrate;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.lessThan;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.lessThan$;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.polynomialResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.unitAware;
import static gov.nasa.jpl.plandev.contrib.streamline.unit_aware.Quantities.quantity;
import static gov.nasa.jpl.plandev.contrib.streamline.unit_aware.StandardUnits.*;
