package gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial;

import gov.nasa.jpl.plandev.contrib.streamline.core.*;
import gov.nasa.jpl.plandev.contrib.streamline.core.CellRefV2.CommutativityTestInput;
import gov.nasa.jpl.plandev.contrib.streamline.core.monads.DynamicsMonad;
import gov.nasa.jpl.plandev.contrib.streamline.core.monads.ErrorCatchingMonad;
import gov.nasa.jpl.plandev.contrib.streamline.debugging.Naming;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.*;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.Clock;
...
import gov.nasa.jpl.plandev.contrib.streamline.unit_aware.StandardUnits;
import gov.nasa.jpl.plandev.contrib.streamline.unit_aware.Unit;
import gov.nasa.jpl.plandev.contrib.streamline.unit_aware.UnitAware;
import gov.nasa.jpl.plandev.contrib.streamline.unit_aware.UnitAwareOperations;
import gov.nasa.jpl.plandev.contrib.streamline.unit_aware.UnitAwareResources;
import gov.nasa.jpl.plandev.contrib.streamline.utils.DoubleUtils;
import gov.nasa.jpl.plandev.merlin.framework.Condition;
...
import static gov.nasa.jpl.plandev.contrib.streamline.core.CellRefV2.autoEffects;
import static gov.nasa.jpl.plandev.contrib.streamline.core.CellRefV2.testing;
...
import static gov.nasa.jpl.plandev.contrib.streamline.core.Expiring.neverExpiring;
...
import static gov.nasa.jpl.plandev.contrib.streamline.core.Resources.*;
import static gov.nasa.jpl.plandev.contrib.streamline.core.monads.DynamicsMonad.bindEffect;
import static gov.nasa.jpl.plandev.contrib.streamline.core.monads.ResourceMonad.*;
import static gov.nasa.jpl.plandev.contrib.streamline.core.monads.ResourceMonad.reduce;
import static gov.nasa.jpl.plandev.contrib.streamline.debugging.Dependencies.addDependency;
import static gov.nasa.jpl.plandev.contrib.streamline.debugging.Naming.*;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.Approximation.approximate;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.black_box.Approximation.relative;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.ClockResources.clock;
...
import static gov.nasa.jpl.plandev.contrib.streamline.unit_aware.UnitAwareResources.extend;
...
public final class PolynomialResources {
   ...
   *     {@link gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources#assertThat(String, Resource)}
