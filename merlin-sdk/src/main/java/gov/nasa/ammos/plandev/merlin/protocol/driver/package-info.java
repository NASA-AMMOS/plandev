 ...
 *
 * <p> The exception (which proves the rule) is the {@link gov.nasa.ammos.plandev.merlin.protocol.driver.CellId} type, which
 ...
 *     {@link gov.nasa.ammos.plandev.merlin.protocol.driver.Initializer} interface grants access to these actions, and is
 *     typically provided to the {@link gov.nasa.ammos.plandev.merlin.protocol.model.ModelType#instantiate(java.time.Instant, java.lang.Object, gov.nasa.ammos.plandev.merlin.protocol.driver.Initializer)}
 *     method. </p>
 *
 *     <p> In the future, resource and topic exportation may be moved to the {@link gov.nasa.ammos.plandev.merlin.protocol.model.ModelType}
 ...
 *     logged on an exported topic), and spawn additional tasks. The {@link gov.nasa.ammos.plandev.merlin.protocol.driver.Scheduler}
 *     interface grants access to these actions, and is typically provided to the {@link gov.nasa.ammos.plandev.merlin.protocol.model.Task#step(gov.nasa.ammos.plandev.merlin.protocol.driver.Scheduler)}
 *     method.</p>
 *
 ...
 *   </li>
 *
 *   <li> During <i>inquisition</i>, a model can only get the current value of a cell. The {@link gov.nasa.ammos.plandev.merlin.protocol.driver.Querier}
 *   interface provides this read-only access to the model's state, and is typically provided to the {@link gov.nasa.ammos.plandev.merlin.protocol.model.Resource#getDynamics(gov.nasa.ammos.plandev.merlin.protocol.driver.Querier)}
 *   and {@link gov.nasa.ammos.plandev.merlin.protocol.model.Condition#nextSatisfied(gov.nasa.ammos.plandev.merlin.protocol.driver.Querier, gov.nasa.ammos.plandev.merlin.protocol.types.Duration)}
 *   methods. </li>
 * </ul>
 */
