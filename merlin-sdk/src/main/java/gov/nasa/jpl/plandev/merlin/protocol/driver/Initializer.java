 ...
 *
 * <p> In a future revision of this API, exportation of resources and topics may be moved to the {@link gov.nasa.jpl.plandev.merlin.protocol.model.ModelType}
...
public interface Initializer {
   ...
   * {@link gov.nasa.jpl.plandev.merlin.protocol.driver.CellId}s, which identify the cell to the driver in future
