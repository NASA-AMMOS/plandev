package gov.nasa.jpl.plandev.procedural.processor;
...
import gov.nasa.jpl.plandev.procedural.scheduling.annotations.WithMappers;
    ...
    for (final var procedure : constraintProcedures) {
      ...
      generatedFiles.add(JavaFile
                             .builder(generatedClassName.packageName() + ".procedures", TypeSpec
                                 .classBuilder(procedure.getSimpleName().toString())
                                 .addModifiers(Modifier.PUBLIC, Modifier.FINAL)
                                 .addSuperinterface(ParameterizedTypeName.get(ClassName.get(gov.nasa.jpl.plandev.procedural.constraints.ProcedureMapper.class), procedureType))
                                 .addMethod(MethodSpec
                                                .methodBuilder("valueSchema")
                                                .addModifiers(Modifier.PUBLIC)
                                                .addAnnotation(Override.class)
