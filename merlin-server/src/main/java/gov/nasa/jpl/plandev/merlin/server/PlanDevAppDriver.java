package gov.nasa.jpl.plandev.merlin.server;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import gov.nasa.jpl.plandev.merlin.server.config.AppConfiguration;
import gov.nasa.jpl.plandev.merlin.server.config.PostgresStore;
import gov.nasa.jpl.plandev.merlin.server.config.Store;
import gov.nasa.jpl.plandev.merlin.server.http.LocalAppExceptionBindings;
import gov.nasa.jpl.plandev.merlin.server.http.MerlinBindings;
import gov.nasa.jpl.plandev.merlin.server.http.MissionModelRepositoryExceptionBindings;
import gov.nasa.jpl.plandev.merlin.server.remotes.ConstraintRepository;
...
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PostgresConstraintRepository;
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PostgresMissionModelRepository;
import gov.nasa.jpl.plandev.merlin.server.services.ValidationWorker;
import gov.nasa.jpl.plandev.permissions.PermissionsService;
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PostgresPlanRepository;
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PostgresResultsCellRepository;
import gov.nasa.jpl.plandev.merlin.server.services.CachedSimulationService;
import gov.nasa.jpl.plandev.merlin.server.services.ConstraintAction;
import gov.nasa.jpl.plandev.merlin.server.services.ConstraintsDSLCompilationService;
...
import gov.nasa.jpl.plandev.merlin.server.services.LocalConstraintService;
import gov.nasa.jpl.plandev.merlin.server.services.LocalMissionModelService;
import gov.nasa.jpl.plandev.merlin.server.services.LocalPlanService;
import gov.nasa.jpl.plandev.merlin.server.services.TypescriptCodeGenerationServiceAdapter;
import gov.nasa.jpl.plandev.merlin.server.services.UnexpectedSubtypeError;
import gov.nasa.jpl.plandev.permissions.gql.GraphQLPermissionsService;
...
public final class PlanDevAppDriver {
  ...
  private static AppConfiguration loadConfiguration() {
    final var logger = LoggerFactory.getLogger(PlanDevAppDriver.class);
