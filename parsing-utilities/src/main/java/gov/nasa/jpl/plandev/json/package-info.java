 ...
 * to define a reflection-based parser as a custom implementation of {@link gov.nasa.jpl.plandev.json.JsonParser}, then
 ...
 *
 * <p> The {@link gov.nasa.jpl.plandev.json.BasicParsers#intP} and {@link gov.nasa.jpl.plandev.json.BasicParsers#stringP}
 * parsers are provided by {@link gov.nasa.jpl.plandev.json.BasicParsers}, and can be statically imported for brevity.
 * They work with the {@code Integer} and {@code String} type, respectively. In order to adapt these to our custom
 * {@code Expr} subclasses, we use the {@link gov.nasa.jpl.plandev.json.JsonParser#map} helper method, which takes two
 ...
 *
 * <p> In addition, notice that we are using the {@link gov.nasa.jpl.plandev.json.BasicParsers#productP} combiner here --
 ...
 * Notice that these methods return a {@link gov.nasa.jpl.plandev.json.JsonObjectParser} rather than the more generic
 * {@link gov.nasa.jpl.plandev.json.JsonParser}: the former allows the format to be extended with additional fields. </p>
 *
 * {@snippet :
 ...
 * The {@link gov.nasa.jpl.plandev.json.BasicParsers#recursiveP(java.util.function.Function)} combiner ties the knot on
 ...
 * The first, {@link gov.nasa.jpl.plandev.json.BasicParsers#chooseP(gov.nasa.jpl.plandev.json.JsonParser[])}, models
 ...
 * by another! </p>
 *
 * <p> The {@link gov.nasa.jpl.plandev.json.SumParsers#sumP(java.lang.String, java.lang.Class, java.util.List)} combiner,
 ...
 * {@link gov.nasa.jpl.plandev.json.JsonParser#parse(javax.json.JsonValue)} on it to convert a JSON document into an
 * {@code Expr<String>}, or invoke {@link gov.nasa.jpl.plandev.json.JsonParser#unparse(java.lang.Object)} to convert
 * an {@code Expr<String>} into a JSON document. As a bonus, the {@link gov.nasa.jpl.plandev.json.JsonParser#getSchema()}
 * method will produce a JSON Schema-compliant document describing the class of JSON documents modeled by
 * this parser! </p>
 */
package gov.nasa.jpl.plandev.json;
