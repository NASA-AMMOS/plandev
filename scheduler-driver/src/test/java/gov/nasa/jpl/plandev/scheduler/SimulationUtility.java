...
import gov.nasa.jpl.plandev.banananation.Configuration;
...
public final class SimulationUtility {
  ...
  private static MissionModel<?> makeMissionModel(final MissionModelBuilder builder, final Configuration config) {
    final var factory = new gov.nasa.jpl.plandev.banananation.generated.GeneratedModelType();
  ...
  getFooMissionModel() {
    final var config = new gov.nasa.jpl.plandev.foomissionmodel.Configuration();
    final var factory = new gov.nasa.jpl.plandev.foomissionmodel.generated.GeneratedModelType();
    final var registry = DirectiveTypeRegistry.extract(factory);
  ...
  public static SchedulerModel getFooSchedulerModel(){
    return new gov.nasa.jpl.plandev.foomissionmodel.generated.GeneratedSchedulerModel();
  }
  ...
  public static SchedulerModel getBananaSchedulerModel(){
    return new gov.nasa.jpl.plandev.banananation.generated.GeneratedSchedulerModel();
  }
}
