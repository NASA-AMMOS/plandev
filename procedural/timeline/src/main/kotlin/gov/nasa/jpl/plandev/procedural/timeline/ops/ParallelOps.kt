...
import gov.nasa.jpl.plandev.procedural.timeline.ops.coalesce.CoalesceNoOp
import gov.nasa.jpl.plandev.procedural.timeline.payloads.Connection
...
import gov.nasa.jpl.plandev.procedural.timeline.util.map2SegmentLists
...
interface ParallelOps<T: IntervalLike<T>, THIS: ParallelOps<T, THIS>>: GeneralOps<T, THIS>, CoalesceNoOp<T, THIS> {
   ...
   *
   * @see gov.nasa.jpl.plandev.procedural.timeline.ops.numeric.SerialNumericOps.integrate for further explanation of [unit].
   */
