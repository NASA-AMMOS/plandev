...
import gov.nasa.ammos.plandev.scheduler.plan.MerlinToProcedureSimulationResultsAdapter;
 ...
 * {@link gov.nasa.ammos.plandev.orchestration.PlanJsonParser} to load a plan from file.
 ...
 * the immutable {@link gov.nasa.ammos.plandev.procedural.timeline.plan.Plan} interface.
 */
public class TypeUtilsEditablePlanAdapter implements gov.nasa.ammos.plandev.procedural.timeline.plan.Plan,
