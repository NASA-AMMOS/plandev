...
@WithMetadata(name="unit", annotation=gov.nasa.jpl.plandev.contrib.metadata.Unit.class)
@WithMetadata(name="description", annotation=gov.nasa.jpl.plandev.merlin.framework.annotations.Description.class)
...
import gov.nasa.jpl.plandev.banananation.activities.BakeBananaBreadActivity;
import gov.nasa.jpl.plandev.banananation.activities.BananaNapActivity;
//import gov.nasa.jpl.plandev.banananation.activities.Banannotation;
import gov.nasa.jpl.plandev.banananation.activities.BiteBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.ChangeProducerActivity;
import gov.nasa.jpl.plandev.banananation.activities.ControllableDurationActivity;
import gov.nasa.jpl.plandev.banananation.activities.DecomposingActivity;
import gov.nasa.jpl.plandev.banananation.activities.DecomposingSpawnActivity;
import gov.nasa.jpl.plandev.banananation.activities.DownloadBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.DurationParameterActivity;
import gov.nasa.jpl.plandev.banananation.activities.ExceptionActivity;
import gov.nasa.jpl.plandev.banananation.activities.GrowBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.LineCountBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.ParameterTestActivity;
import gov.nasa.jpl.plandev.banananation.activities.PeelBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.PickBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.RipenBananaActivity;
import gov.nasa.jpl.plandev.banananation.activities.ThrowBananaActivity;
...
import gov.nasa.jpl.plandev.merlin.framework.annotations.MissionModel.WithSubsystem;
