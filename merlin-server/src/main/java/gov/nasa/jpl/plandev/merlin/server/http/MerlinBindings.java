package gov.nasa.jpl.plandev.merlin.server.http;

import gov.nasa.jpl.plandev.constraints.InputMismatchException;
...
import gov.nasa.jpl.plandev.merlin.server.services.ConstraintAction;
import gov.nasa.jpl.plandev.merlin.server.models.PlanId;
import gov.nasa.jpl.plandev.merlin.server.services.GenerateConstraintsLibAction;
import gov.nasa.jpl.plandev.merlin.server.services.GetSimulationResultsAction;
import gov.nasa.jpl.plandev.merlin.server.services.LocalMissionModelService;
import gov.nasa.jpl.plandev.merlin.server.services.MissionModelService;
import gov.nasa.jpl.plandev.merlin.server.services.PlanService;
import gov.nasa.jpl.plandev.permissions.HasuraAction;
import gov.nasa.jpl.plandev.permissions.PermissionsService;
import gov.nasa.jpl.plandev.permissions.exceptions.ExceptionSerializers;
...
import static gov.nasa.jpl.plandev.merlin.server.http.MerlinParsers.parseJson;

import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraActivityActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraActivityBulkActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraConstraintsCodeAction;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraConstraintsViolationsActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraSimulateActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraUploadExternalDatasetActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraMissionModelActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraMissionModelArgumentsActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraMissionModelEventTriggerP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraPlanActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraExtendExternalDatasetActionP;
import static gov.nasa.jpl.plandev.merlin.server.http.HasuraParsers.hasuraNewConstraintRevisionEventTriggerP;
...
public final class MerlinBindings implements Plugin {
  ...
  private void getSimulationResults(final Context ctx) {
    try {
      ...
      ctx.status(404).result(ResponseSerializers.serializeNoSuchMissionModelException(ex).toString());
    } catch (final gov.nasa.jpl.plandev.permissions.exceptions.NoSuchPlanException ex) {
  ...
  private void checkPermissions(
      ...
      final gov.nasa.jpl.plandev.merlin.server.models.HasuraAction.Session session,
      final PlanId planId
  ) throws gov.nasa.jpl.plandev.permissions.exceptions.NoSuchPlanException, Forbidden, IOException, PermissionsServiceException
  {
    final var permissionsPlanId = new gov.nasa.jpl.plandev.permissions.gql.PlanId(planId.id());
