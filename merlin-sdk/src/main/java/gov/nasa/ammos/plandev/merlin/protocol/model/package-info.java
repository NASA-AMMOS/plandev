 ...
 * the interfaces implemented by the model (in the {@link gov.nasa.ammos.plandev.merlin.protocol.model} package) provide
 ...
 *
 * <p> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.ModelType} interface describes the mission
 ...
 *
 * <ul>
 *    <li> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.ModelType} interface describes the mission
 ...
 *
 *    <li> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.InputType} interface describes a type of data that can
 ...
 *
 *    <li> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.OutputType} interface describes a type of data that can
 ...
 *    and resources. </li>
 *
 *    <li> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.DirectiveType} interface describes a directive type,
 ...
 *    executable {@link gov.nasa.ammos.plandev.merlin.protocol.model.Task} against a model instance.  </li>
 *
 *    <li> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.Resource} interface describes a resource, an observable
 ...
 *
 *    <li> The {@link gov.nasa.ammos.plandev.merlin.protocol.model.CellType} interface describes the internal state of a
