...
import gov.nasa.jpl.plandev.merlin.driver.engine.SimulationEngine;
import gov.nasa.jpl.plandev.merlin.driver.timeline.TemporalEventSource;
...
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.duration;
...
public final class ActivityInstanceTest {
   ...
   * of {@link gov.nasa.jpl.plandev.merlin.driver.engine.SimulationEngine#computeResults(
   ...
   * {@link gov.nasa.jpl.plandev.merlin.driver.engine.SimulationEngine.ExecutionState.AwaitingChildren AwaitingChildren},
   * {@link gov.nasa.jpl.plandev.merlin.driver.engine.SimulationEngine.ExecutionState.InProgress InProgress}, and
   * {@link gov.nasa.jpl.plandev.merlin.driver.engine.SimulationEngine.ExecutionState.Terminated Terminated}.
   */
  @Test
