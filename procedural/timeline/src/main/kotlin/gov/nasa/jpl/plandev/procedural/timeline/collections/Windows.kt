...
import gov.nasa.jpl.plandev.procedural.timeline.BoundsTransformer
...
import gov.nasa.jpl.plandev.procedural.timeline.ops.SerialOps
import gov.nasa.jpl.plandev.procedural.timeline.ops.coalesce.CoalesceIntervalsOp
    ...
    NonZeroDurationOps<Interval, Windows>
{
   ...
   *
   * Essentially a rename of [gov.nasa.jpl.plandev.procedural.timeline.ops.GeneralOps.unset].
   */
   ...
   *
   * Unlike [gov.nasa.jpl.plandev.procedural.timeline.ops.ParallelOps.shiftEndpoints], this function
