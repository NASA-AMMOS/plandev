 ...
 *
 *   <li>
 *     Driver calls {@link gov.nasa.jpl.aerie.merlin.protocol.model.ModelType#instantiate(java.time.Instant, Object, gov.nasa.jpl.aerie.merlin.protocol.driver.Initializer)}
 *     to construct a model instance, providing a {@link gov.nasa.jpl.aerie.merlin.protocol.driver.Initializer}.
 *
 *     <ul>
 *       <li> Model calls {@link gov.nasa.jpl.aerie.merlin.protocol.driver.Initializer#allocate(Object, gov.nasa.jpl.aerie.merlin.protocol.model.CellType, java.util.function.Function, gov.nasa.jpl.aerie.merlin.protocol.driver.Topic)}
 ...
 *
 *       <li> Model calls {@link gov.nasa.jpl.aerie.merlin.protocol.driver.Initializer#resource(String, gov.nasa.jpl.aerie.merlin.protocol.model.Resource)}
 *       any number of times to register an observable {@link gov.nasa.jpl.aerie.merlin.protocol.model.Resource}. </li>
 *
 *       <li> Model calls {@link gov.nasa.jpl.aerie.merlin.protocol.driver.Initializer#topic(String, gov.nasa.jpl.aerie.merlin.protocol.driver.Topic, gov.nasa.jpl.aerie.merlin.protocol.model.OutputType)}
 ...
 *   and then {@link gov.nasa.jpl.aerie.merlin.protocol.model.DirectiveType#getTaskFactory(Object, java.util.Map)} to instantiate
 ...
 *
 *     <ul>
 *       <li> Model calls {@link gov.nasa.jpl.aerie.merlin.protocol.driver.Scheduler#emit(Object, gov.nasa.jpl.aerie.merlin.protocol.driver.Topic)}
 ...
 *
 *           <li> Driver calls {@link gov.nasa.jpl.aerie.merlin.protocol.model.CellType#step(Object, gov.nasa.jpl.aerie.merlin.protocol.types.Duration)}
 *           and {@link gov.nasa.jpl.aerie.merlin.protocol.model.CellType#apply(Object, Object)}
