package gov.nasa.jpl.plandev.procedural.timeline.collections.profiles
...
import gov.nasa.jpl.plandev.procedural.timeline.ops.numeric.LinearOps
import gov.nasa.jpl.plandev.procedural.timeline.payloads.Segment
import gov.nasa.jpl.plandev.procedural.timeline.ops.numeric.SerialNumericOps
import gov.nasa.jpl.plandev.procedural.timeline.payloads.LinearEquation
...
import gov.nasa.jpl.plandev.procedural.timeline.util.duration.unaryMinus
import kotlin.jvm.optionals.getOrNull
import kotlin.math.pow
import gov.nasa.jpl.plandev.procedural.timeline.util.duration.*;
    ...
    LinearOps<Real>
{
  ...
  /***/ companion object {
    /**
     * Converts a list of serialized value segments into a real profile; for use with [gov.nasa.jpl.plandev.procedural.timeline.plan.Plan.resource].
     *
