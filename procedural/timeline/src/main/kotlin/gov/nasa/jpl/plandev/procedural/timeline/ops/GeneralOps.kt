package gov.nasa.jpl.plandev.procedural.timeline.ops

import gov.nasa.jpl.plandev.merlin.protocol.types.Duration
import gov.nasa.jpl.plandev.procedural.timeline.*
import gov.nasa.jpl.plandev.procedural.timeline.collections.Universal
import gov.nasa.jpl.plandev.procedural.timeline.collections.Windows
...
import gov.nasa.jpl.plandev.procedural.timeline.util.coalesceList
import gov.nasa.jpl.plandev.procedural.timeline.util.map2ParallelLists
import gov.nasa.jpl.plandev.procedural.timeline.util.sorted
import gov.nasa.jpl.plandev.procedural.timeline.util.truncateList
...
interface GeneralOps<V: IntervalLike<V>, THIS: GeneralOps<V, THIS>>: Timeline<V, THIS> {
   ...
   *
   * All timeline collections are required to add either [gov.nasa.jpl.plandev.procedural.timeline.ops.coalesce.CoalesceNoOp] or
   * [gov.nasa.jpl.plandev.procedural.timeline.ops.coalesce.CoalesceSegmentsOp] to satisfy this requirement.
   *
