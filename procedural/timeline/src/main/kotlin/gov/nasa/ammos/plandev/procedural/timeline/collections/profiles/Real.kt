...
import gov.nasa.ammos.plandev.procedural.timeline.ops.numeric.LinearOps
import gov.nasa.ammos.plandev.procedural.timeline.payloads.Segment
import gov.nasa.ammos.plandev.procedural.timeline.ops.numeric.SerialNumericOps
import gov.nasa.ammos.plandev.procedural.timeline.payloads.LinearEquation
import gov.nasa.ammos.plandev.procedural.timeline.payloads.transpose
import gov.nasa.ammos.plandev.procedural.timeline.util.preprocessList
import gov.nasa.ammos.plandev.procedural.timeline.util.truncateList
import gov.nasa.ammos.plandev.procedural.timeline.util.duration.unaryMinus
import kotlin.jvm.optionals.getOrNull
import kotlin.math.pow
import gov.nasa.ammos.plandev.procedural.timeline.util.duration.*;
    ...
    LinearOps<Real>
{
  ...
  /***/ companion object {
    /**
     * Converts a list of serialized value segments into a real profile; for use with [gov.nasa.ammos.plandev.procedural.timeline.plan.Plan.resource].
     *
