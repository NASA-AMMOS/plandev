...
import gov.nasa.jpl.plandev.examples.model.migration.activities.BakeBananaBreadActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.BiteBananaActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.ChangeProducerActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.GrowBananaActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.LineCountBananaActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.NewDurationParameterActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.PeelBananaActivity;
import gov.nasa.jpl.plandev.examples.model.migration.activities.PickBananaActivity;
