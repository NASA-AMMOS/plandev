...
5. Empty the contents of [`contrib`'s SPICE resources](../contrib/src/main/resources/gov/nasa/jpl/plandev/spice).
6. Move `JNISpice.dll`, `libJNISpice_Intel.jnilib`, and `libJNISpice_Intel.so` to [`contrib`'s SPICE resources](../contrib/src/main/resources/gov/nasa/jpl/plandev/spice).
...
2. Combine them into a single binary using `lipo`:
   ...
   ```
3. Move `libJNISpice.jnilib` into [`contrib`'s SPICE resources](../contrib/src/main/resources/gov/nasa/jpl/plandev/spice).
...
7. In a terminal on the host machine, copy the binary onto your machine:
   ...
   ```
8. Move `libJNISpice_M1.so` to [`contrib`'s SPICE resources](../contrib/src/main/resources/gov/nasa/jpl/plandev/spice).
