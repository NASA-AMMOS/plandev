...
import gov.nasa.jpl.plandev.contrib.cells.register.RegisterCell;
import gov.nasa.jpl.plandev.contrib.cells.register.RegisterEffect;
import gov.nasa.jpl.plandev.merlin.framework.CellRef;
import gov.nasa.jpl.plandev.merlin.framework.resources.discrete.DiscreteResource;
