...
import gov.nasa.jpl.plandev.scheduler.plan.SchedulerPlanEditAdapter;
import gov.nasa.jpl.plandev.scheduler.plan.SchedulerToProcedurePlanAdapter;
import gov.nasa.jpl.plandev.scheduler.simulation.SimulationFacade;
import gov.nasa.jpl.plandev.scheduler.solver.ConflictSatisfaction;
...
import static gov.nasa.jpl.plandev.scheduler.plan.SchedulerPlanEditAdapter.toSchedulingActivity;
