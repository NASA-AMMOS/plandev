...
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.ADDITIONAL_DERIVATION_GROUP;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.ADDITIONAL_EVENT_TYPE;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.ADDITIONAL_SOURCE_KEY;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.DERIVATION_GROUP;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.EVENT_TYPE;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.SOURCE_KEY;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.SOURCE_TYPE;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.uploadExternalSourceEventTypes;
import static gov.nasa.ammos.plandev.e2e.utils.ExternalEventUtils.uploadExternalSources;
