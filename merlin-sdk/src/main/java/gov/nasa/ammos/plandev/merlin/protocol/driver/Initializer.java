 ...
 *
 * <p> In a future revision of this API, exportation of resources and topics may be moved to the {@link ModelType}
...
public interface Initializer {
   ...
   * {@link CellId}s, which identify the cell to the driver in future
