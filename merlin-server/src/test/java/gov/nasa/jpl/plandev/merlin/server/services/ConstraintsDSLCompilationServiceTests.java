...
import gov.nasa.jpl.plandev.constraints.tree.AbsoluteInterval;
import gov.nasa.jpl.plandev.constraints.time.Interval;
import gov.nasa.jpl.plandev.constraints.tree.AccumulatedDuration;
import gov.nasa.jpl.plandev.constraints.tree.ActivitySpan;
import gov.nasa.jpl.plandev.constraints.tree.ActivityWindow;
import gov.nasa.jpl.plandev.constraints.tree.And;
import gov.nasa.jpl.plandev.constraints.tree.AssignGaps;
import gov.nasa.jpl.plandev.constraints.tree.Changes;
import gov.nasa.jpl.plandev.constraints.tree.DiscreteParameter;
import gov.nasa.jpl.plandev.constraints.tree.DiscreteResource;
import gov.nasa.jpl.plandev.constraints.tree.DiscreteValue;
import gov.nasa.jpl.plandev.constraints.tree.DurationLiteral;
import gov.nasa.jpl.plandev.constraints.tree.Ends;
import gov.nasa.jpl.plandev.constraints.tree.Equal;
import gov.nasa.jpl.plandev.constraints.tree.Expression;
import gov.nasa.jpl.plandev.constraints.tree.ForEachActivitySpans;
import gov.nasa.jpl.plandev.constraints.tree.ForEachActivityViolations;
import gov.nasa.jpl.plandev.constraints.tree.GreaterThan;
import gov.nasa.jpl.plandev.constraints.tree.GreaterThanOrEqual;
import gov.nasa.jpl.plandev.constraints.tree.KeepTrueSegment;
import gov.nasa.jpl.plandev.constraints.tree.LessThan;
import gov.nasa.jpl.plandev.constraints.tree.LessThanOrEqual;
import gov.nasa.jpl.plandev.constraints.tree.LongerThan;
import gov.nasa.jpl.plandev.constraints.tree.Not;
import gov.nasa.jpl.plandev.constraints.tree.NotEqual;
import gov.nasa.jpl.plandev.constraints.tree.Or;
import gov.nasa.jpl.plandev.constraints.tree.Plus;
import gov.nasa.jpl.plandev.constraints.tree.ProfileExpression;
import gov.nasa.jpl.plandev.constraints.tree.Rate;
import gov.nasa.jpl.plandev.constraints.tree.RealParameter;
import gov.nasa.jpl.plandev.constraints.tree.RealResource;
import gov.nasa.jpl.plandev.constraints.tree.RealValue;
import gov.nasa.jpl.plandev.constraints.tree.RollingThreshold;
import gov.nasa.jpl.plandev.constraints.tree.ShiftBy;
import gov.nasa.jpl.plandev.constraints.tree.ShiftEdges;
import gov.nasa.jpl.plandev.constraints.tree.ShorterThan;
import gov.nasa.jpl.plandev.constraints.tree.SpansConnectTo;
import gov.nasa.jpl.plandev.constraints.tree.SpansContains;
import gov.nasa.jpl.plandev.constraints.tree.SpansFromWindows;
import gov.nasa.jpl.plandev.constraints.tree.SpansSelectWhenTrue;
import gov.nasa.jpl.plandev.constraints.tree.Split;
import gov.nasa.jpl.plandev.constraints.tree.Starts;
import gov.nasa.jpl.plandev.constraints.tree.Times;
import gov.nasa.jpl.plandev.constraints.tree.Transition;
import gov.nasa.jpl.plandev.constraints.tree.ValueAt;
import gov.nasa.jpl.plandev.constraints.tree.ViolationsOfWindows;
import gov.nasa.jpl.plandev.constraints.tree.WindowsFromSpans;
import gov.nasa.jpl.plandev.constraints.tree.WindowsValue;
...
import gov.nasa.jpl.plandev.merlin.server.mocks.StubMissionModelService;
import gov.nasa.jpl.plandev.merlin.server.mocks.StubPlanService;
...
import static gov.nasa.jpl.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.DeficitHull;
import static gov.nasa.jpl.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.DeficitSpans;
import static gov.nasa.jpl.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.ExcessHull;
import static gov.nasa.jpl.plandev.constraints.tree.RollingThreshold.RollingThresholdAlgorithm.ExcessSpans;
