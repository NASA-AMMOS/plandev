...
import gov.nasa.ammos.plandev.constraints.time.UnsplittableSpanException;
...
import static gov.nasa.ammos.plandev.constraints.time.Interval.FOREVER;
...
import static gov.nasa.ammos.plandev.merlin.protocol.types.Duration.MILLISECOND;
