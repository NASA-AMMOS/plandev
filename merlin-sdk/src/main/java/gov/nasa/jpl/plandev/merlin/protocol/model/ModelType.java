 ...
 * to an abstract domain type relevant to the model. See {@linkplain gov.nasa.jpl.plandev.merlin.protocol the package
...
public interface ModelType<Config, Model> {
   ...
   * initializer. In turn, the initializer returns {@link gov.nasa.jpl.plandev.merlin.protocol.driver.CellId}s, which do
