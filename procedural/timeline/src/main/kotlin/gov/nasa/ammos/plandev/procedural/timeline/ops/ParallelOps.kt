...
import gov.nasa.ammos.plandev.procedural.timeline.ops.coalesce.CoalesceNoOp
import gov.nasa.ammos.plandev.procedural.timeline.payloads.Connection
...
interface ParallelOps<T: IntervalLike<T>, THIS: ParallelOps<T, THIS>>: GeneralOps<T, THIS>, CoalesceNoOp<T, THIS> {
   ...
   *
   * @see gov.nasa.ammos.plandev.procedural.timeline.ops.numeric.SerialNumericOps.integrate for further explanation of [unit].
   */
