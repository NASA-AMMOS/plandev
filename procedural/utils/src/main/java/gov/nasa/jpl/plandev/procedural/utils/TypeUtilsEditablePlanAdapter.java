 ...
 * the immutable {@link gov.nasa.jpl.plandev.procedural.timeline.plan.Plan} interface.
 */
public class TypeUtilsEditablePlanAdapter implements gov.nasa.jpl.plandev.procedural.timeline.plan.Plan,
