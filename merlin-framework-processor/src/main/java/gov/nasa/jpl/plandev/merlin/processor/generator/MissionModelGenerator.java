package gov.nasa.jpl.plandev.merlin.processor.generator;
...
import gov.nasa.jpl.plandev.merlin.framework.ActivityMapper;
import gov.nasa.jpl.plandev.merlin.framework.EmptyInputType;
import gov.nasa.jpl.plandev.merlin.framework.ModelActions;
import gov.nasa.jpl.plandev.merlin.framework.ValueMapper;
import gov.nasa.jpl.plandev.merlin.processor.MissionModelProcessor;
import gov.nasa.jpl.plandev.merlin.processor.Resolver;
import gov.nasa.jpl.plandev.merlin.processor.TypePattern;
import gov.nasa.jpl.plandev.merlin.processor.metamodel.ActivityTypeRecord;
import gov.nasa.jpl.plandev.merlin.processor.metamodel.EffectModelRecord;
import gov.nasa.jpl.plandev.merlin.processor.metamodel.InputTypeRecord;
import gov.nasa.jpl.plandev.merlin.processor.metamodel.MissionModelRecord;
import gov.nasa.jpl.plandev.merlin.protocol.driver.Initializer;
import gov.nasa.jpl.plandev.merlin.protocol.driver.Scheduler;
import gov.nasa.jpl.plandev.merlin.protocol.driver.Topic;
import gov.nasa.jpl.plandev.merlin.protocol.model.InputType;
import gov.nasa.jpl.plandev.merlin.protocol.model.MerlinPlugin;
                ...
                MethodSpec
                    ...
                    .returns(
                        ParameterizedTypeName.get(
                            ...
                            ParameterizedTypeName.get(
                                ClassName.get(gov.nasa.jpl.plandev.merlin.framework.ActivityMapper.class),
                                ClassName.get(missionModel.topLevelModel()),
            ...
            .addMethod(
                MethodSpec
                    ...
                    .addParameter(
                        ...
                        Modifier.FINAL)
                    .addParameter(
                        ClassName.get(gov.nasa.jpl.plandev.merlin.protocol.driver.Initializer.class),
                        "builder",
                        Modifier.FINAL)
                    ...
                    .addStatement(
                        "final var $L = new $T($L)",
                        "registrar",
                        gov.nasa.jpl.plandev.merlin.framework.Registrar.class,
                        "builder")
                    .addCode("\n")
                    .addStatement(
                        "return $T.initializing($L, () -> $L)",
                        gov.nasa.jpl.plandev.merlin.framework.InitializationContext.class,
                        "builder",
        ...
        TypeSpec
            ...
            .addAnnotation(
                AnnotationSpec
                    ...
                    .build())
            .addModifiers(Modifier.PUBLIC)
            .superclass(gov.nasa.jpl.plandev.merlin.framework.ModelActions.class)
                        ...
                        .of(
                            MethodSpec
                                ...
                                .addStatement(
                                    ...
                                    gov.nasa.jpl.plandev.merlin.framework.ModelActions.class,
                                    "mapper",
                                    "model",
                                    "activity")
                                .build(),
                            ...
                            MethodSpec
                                ...
                                .addParameter(
                                    ParameterSpec
                                        .builder(
                                            gov.nasa.jpl.plandev.merlin.protocol.types.Duration.class,
                                            "unit")
                                        .addModifiers(Modifier.FINAL)
                                        .build())
                                .addParameter(
  ...
  public Optional<TypeSpec> generateInputType(final MissionModelRecord missionModel,
    ...
    return Optional.of(TypeSpec
        ...
        .addSuperinterface(ParameterizedTypeName.get(
            ClassName.get(gov.nasa.jpl.plandev.merlin.protocol.model.InputType.class),
        ...
        .addFields(
            inputType.parameters()
                     ...
                     .map(parameter -> FieldSpec
                         .builder(
                             ParameterizedTypeName.get(
                                 ClassName.get(gov.nasa.jpl.plandev.merlin.framework.ValueMapper.class),
