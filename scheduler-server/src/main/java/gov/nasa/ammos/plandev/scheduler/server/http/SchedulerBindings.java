...
import static gov.nasa.ammos.plandev.scheduler.server.http.SchedulerParsers.hasuraSchedulingDSLTypescriptActionP;
import static gov.nasa.ammos.plandev.scheduler.server.http.SchedulerParsers.hasuraSchedulingGoalEventTriggerP;
import static gov.nasa.ammos.plandev.scheduler.server.http.SchedulerParsers.hasuraSpecificationActionP;
