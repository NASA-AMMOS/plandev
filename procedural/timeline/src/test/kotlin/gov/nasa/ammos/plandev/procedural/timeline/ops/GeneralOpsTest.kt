...
import gov.nasa.ammos.plandev.merlin.protocol.types.Duration.milliseconds
import gov.nasa.ammos.plandev.merlin.protocol.types.Duration.seconds
import gov.nasa.ammos.plandev.procedural.timeline.*
import gov.nasa.ammos.plandev.procedural.timeline.Interval.Companion.at
import gov.nasa.ammos.plandev.procedural.timeline.Interval.Companion.between
import gov.nasa.ammos.plandev.procedural.timeline.Interval.Companion.betweenClosedOpen
import gov.nasa.ammos.plandev.procedural.timeline.Interval.Inclusivity.Exclusive
import gov.nasa.ammos.plandev.procedural.timeline.Interval.Inclusivity.Inclusive
import gov.nasa.ammos.plandev.procedural.timeline.collections.Universal
import gov.nasa.ammos.plandev.procedural.timeline.collections.profiles.Constants
import gov.nasa.ammos.plandev.procedural.timeline.collections.profiles.Numbers
...
import gov.nasa.ammos.plandev.procedural.timeline.util.duration.div
