...
import gov.nasa.jpl.plandev.contrib.streamline.core.monads.DynamicsMonad;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.Discrete;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial;

import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.discreteResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteDynamicsMonad.effect;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial.polynomial;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.polynomialResource;
...
import static gov.nasa.jpl.plandev.contrib.streamline.debugging.Naming.name;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.discreteResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteDynamicsMonad.effect;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial.polynomial;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.polynomialResource;
...
```java
import gov.nasa.jpl.plandev.contrib.streamline.core.*;
import gov.nasa.jpl.plandev.merlin.protocol.types.Duration;

import static gov.nasa.jpl.plandev.contrib.streamline.core.Expiring.expiring;
import static gov.nasa.jpl.plandev.contrib.streamline.debugging.Naming.name;
...
import gov.nasa.jpl.plandev.contrib.streamline.core.Dynamics;
import gov.nasa.jpl.plandev.contrib.streamline.core.MutableResource;
import gov.nasa.jpl.plandev.contrib.streamline.core.Resource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.Discrete;
import gov.nasa.jpl.plandev.merlin.protocol.types.Duration;
import org.apache.commons.math3.geometry.euclidean.threed.Rotation;
import org.apache.commons.math3.geometry.euclidean.threed.Vector3D;
...
import static gov.nasa.jpl.plandev.contrib.streamline.core.Reactions.wheneverDynamicsChange;
import static gov.nasa.jpl.plandev.contrib.streamline.core.Resources.currentValue;
import static gov.nasa.jpl.plandev.contrib.streamline.core.monads.DynamicsMonad.*;
import static gov.nasa.jpl.plandev.contrib.streamline.debugging.Naming.name;
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.SECONDS;
...
import static gov.nasa.jpl.plandev.contrib.streamline.core.Resources.currentValue;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.*;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.discreteResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteDynamicsMonad.effect;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.discreteResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.asPolynomial;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.integrate;
...
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.Discrete;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources;

import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.discreteResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.*;
...
```java
import gov.nasa.jpl.plandev.contrib.streamline.core.MutableResource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClock;
import gov.nasa.jpl.plandev.merlin.protocol.types.Duration;

import static gov.nasa.jpl.plandev.contrib.streamline.core.MutableResource.resource;
import static gov.nasa.jpl.plandev.contrib.streamline.core.MutableResource.set;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClock.*;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClockEffects.*;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClockResources.lessThanOrEquals;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.constant;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.when;
import static gov.nasa.jpl.plandev.merlin.framework.ModelActions.waitUntil;
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.MINUTES;
...
import gov.nasa.jpl.plandev.contrib.streamline.core.Resource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.Discrete;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteResourceMonad;
import org.apache.commons.lang3.StringUtils;

import java.util.List;
import java.util.Map;

import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteResourceMonad.map;
...
import gov.nasa.jpl.plandev.contrib.streamline.core.Resource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.Discrete;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteResourceMonad;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial;

import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.monads.DiscreteResourceMonad.map;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.greaterThanOrEquals;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.choose;
...
For example:
```java
import gov.nasa.jpl.plandev.contrib.streamline.core.Reactions;
import gov.nasa.jpl.plandev.contrib.streamline.core.Resource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial;

import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.not;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.when;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.*;
import static gov.nasa.jpl.plandev.merlin.framework.ModelActions.waitUntil;
...
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.HOURS;
...
import gov.nasa.jpl.plandev.contrib.streamline.core.Resource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClock;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClockEffects;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClockResources;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.Discrete;
import gov.nasa.jpl.plandev.merlin.protocol.types.Duration;

import static gov.nasa.jpl.plandev.contrib.streamline.core.MutableResource.resource;
import static gov.nasa.jpl.plandev.contrib.streamline.core.Reactions.every;
import static gov.nasa.jpl.plandev.contrib.streamline.core.Reactions.whenever;
import static gov.nasa.jpl.plandev.contrib.streamline.core.Resources.currentValue;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClock.runningStopwatch;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClockEffects.restart;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.clocks.VariableClockResources.greaterThanOrEquals;
...
import gov.nasa.jpl.plandev.contrib.streamline.core.MutableResource;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial;
import gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialEffects;
import gov.nasa.jpl.plandev.merlin.framework.ModelActions;
import gov.nasa.jpl.plandev.merlin.protocol.types.Duration;

import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.Polynomial.polynomial;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialEffects.*;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.polynomialResource;
...
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.*;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.turnOff;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.turnOn;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.choose;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.discrete.DiscreteResources.discreteResource;
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.*;
...
import static gov.nasa.jpl.plandev.contrib.streamline.modeling.polynomial.PolynomialEffects.providing;
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.MINUTES;
