package gov.nasa.jpl.plandev.constraints.tree;

import gov.nasa.jpl.plandev.constraints.InputMismatchException;
import gov.nasa.jpl.plandev.constraints.model.ActivityInstance;
import gov.nasa.jpl.plandev.constraints.model.DiscreteProfile;
import gov.nasa.jpl.plandev.constraints.model.EDSLConstraintResult;
...
import gov.nasa.jpl.plandev.constraints.model.Violation;
import gov.nasa.jpl.plandev.constraints.time.Interval;
import gov.nasa.jpl.plandev.constraints.time.IntervalMap;
import gov.nasa.jpl.plandev.constraints.time.Segment;
import gov.nasa.jpl.plandev.constraints.time.Spans;
import gov.nasa.jpl.plandev.constraints.time.UnsplittableSpanException;
...
import static gov.nasa.jpl.plandev.constraints.time.Interval.FOREVER;
import static gov.nasa.jpl.plandev.constraints.time.Interval.Inclusivity.Exclusive;
import static gov.nasa.jpl.plandev.constraints.time.Interval.Inclusivity.Inclusive;
import static gov.nasa.jpl.plandev.constraints.time.Interval.at;
import static gov.nasa.jpl.plandev.constraints.time.Interval.interval;
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.MICROSECONDS;
import static gov.nasa.jpl.plandev.merlin.protocol.types.Duration.MILLISECOND;
