...
import gov.nasa.jpl.plandev.contrib.streamline.debugging.Context;
import gov.nasa.jpl.plandev.contrib.streamline.debugging.Profiling;
import gov.nasa.jpl.plandev.merlin.framework.CellRef;
import gov.nasa.jpl.plandev.contrib.streamline.core.CellRefV2.Cell;
import gov.nasa.jpl.plandev.merlin.protocol.model.EffectTrait;

import static gov.nasa.jpl.plandev.contrib.streamline.core.CellRefV2.allocate;
import static gov.nasa.jpl.plandev.contrib.streamline.core.CellRefV2.autoEffects;
import static gov.nasa.jpl.plandev.contrib.streamline.core.monads.DynamicsMonad.pure;
...
import static gov.nasa.jpl.plandev.contrib.streamline.debugging.Profiling.profileEffects;
