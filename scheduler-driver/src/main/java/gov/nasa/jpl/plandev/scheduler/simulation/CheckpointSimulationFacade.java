...
import gov.nasa.jpl.plandev.merlin.driver.CachedSimulationEngine;
import gov.nasa.jpl.plandev.merlin.driver.CheckpointSimulationDriver;
...
import gov.nasa.jpl.plandev.merlin.driver.SimulationResultsComputerInputs;
import gov.nasa.jpl.plandev.merlin.framework.ThreadedTask;
...
import static gov.nasa.jpl.plandev.merlin.driver.CheckpointSimulationDriver.onceAllActivitiesAreFinished;
import static gov.nasa.jpl.plandev.scheduler.simulation.SimulationFacadeUtils.scheduleFromPlan;
import static gov.nasa.jpl.plandev.scheduler.simulation.SimulationFacadeUtils.schedulingActToActivityDir;
import static gov.nasa.jpl.plandev.scheduler.simulation.SimulationFacadeUtils.updatePlanWithChildActivities;
...
public class CheckpointSimulationFacade implements SimulationFacade {
  ...
  public SimulationData simulateWithResults(
    ...
    this.latestSimulationData = new SimulationData(
        plan,
        driverResults,
        new gov.nasa.jpl.plandev.constraints.model.SimulationResults(driverResults)
    );
