...
public final class SimulationDemo implements ProcedureMapper<gov.nasa.ammos.aerie.procedural.examples.bananaprocedures.procedures.SimulationDemo> {
  @Override
  public ValueSchema valueSchema() {
    return AutoValueMappers.gov_nasa_ammos_aerie_procedural_examples_bananaprocedures_procedures_SimulationDemo(
            BasicValueMappers.$int()).getValueSchema();
  }

  @Override
  public InputType<gov.nasa.ammos.aerie.procedural.examples.bananaprocedures.procedures.SimulationDemo> getInputType(
      ) {
    return new InputMapper();
  }

  public final class InputMapper implements InputType<gov.nasa.ammos.aerie.procedural.examples.bananaprocedures.procedures.SimulationDemo> {
    ...
    public Map<String, SerializedValue> getArguments(
        final gov.nasa.ammos.aerie.procedural.examples.bananaprocedures.procedures.SimulationDemo input) {
    ...
    @Override
    public gov.nasa.ammos.aerie.procedural.examples.bananaprocedures.procedures.SimulationDemo instantiate(
        final Map<String, SerializedValue> arguments) throws InstantiationException {
      Optional<Integer> quantity = Optional.empty();

      final var instantiationExBuilder = new InstantiationException.Builder("SimulationDemo");
      ...
      return new gov.nasa.ammos.aerie.procedural.examples.bananaprocedures.procedures.SimulationDemo(quantity.get());
    }
