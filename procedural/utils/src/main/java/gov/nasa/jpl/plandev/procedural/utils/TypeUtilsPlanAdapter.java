...
import gov.nasa.jpl.plandev.procedural.timeline.util.duration.DurationKt;
...
/**
 * An adapter from the type-utils {@link Plan} class to the procedural {@link gov.nasa.jpl.plandev.procedural.timeline.plan.Plan} interface.
 */
public record TypeUtilsPlanAdapter(Plan plan) implements gov.nasa.jpl.plandev.procedural.timeline.plan.Plan {
  @NotNull
  @Override
