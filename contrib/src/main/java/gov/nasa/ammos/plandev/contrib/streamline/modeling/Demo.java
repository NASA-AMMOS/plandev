...
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.black_box.DifferentiableResources.divide;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.black_box.DivergenceEstimators.byBoundingError;
...
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.toggle;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.discrete.DiscreteEffects.using;
...
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialEffects.consume;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.asPolynomial;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.asUnitAwarePolynomial;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.clamp;
...
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.lessThan;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.lessThan$;
import static gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.PolynomialResources.unitAware;
