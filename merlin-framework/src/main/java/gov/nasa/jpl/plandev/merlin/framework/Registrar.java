...
public final class Registrar {
  ...
  private static <Value> gov.nasa.jpl.plandev.merlin.protocol.model.Resource<Value> makeResource(
      final String type,
    ...
    return new gov.nasa.jpl.plandev.merlin.protocol.model.Resource<>() {
      @Override
