...
public final class FruitThresholdConstraint implements ProcedureMapper<gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint> {
  @Override
  public ValueSchema valueSchema() {
    return AutoValueMappers.gov_nasa_jpl_aerie_e2e_procedural_scheduling_procedures_FruitThresholdConstraint(
            BasicValueMappers.$int(),
            BasicValueMappers.$int()).getValueSchema();
  }

  @Override
  public InputType<gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint> getInputType(
      ) {
    return new InputMapper();
  }

  public final class InputMapper implements InputType<gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint> {
    ...
    public Map<String, SerializedValue> getArguments(
        final gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint input) {
    ...
    @Override
    public gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint instantiate(
        final Map<String, SerializedValue> arguments) throws InstantiationException {
      final var defaults = new gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint.Template();
      ...
      final var instantiationExBuilder = new InstantiationException.Builder("FruitThresholdConstraint");
      ...
      return new gov.nasa.jpl.aerie.e2e.procedural.scheduling.procedures.FruitThresholdConstraint(lowerBound.get(), upperBound.get());
    }
