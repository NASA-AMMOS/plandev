...
import gov.nasa.ammos.plandev.procedural.timeline.util.map2ParallelLists
import gov.nasa.ammos.plandev.procedural.timeline.util.sorted
...
interface GeneralOps<V: IntervalLike<V>, THIS: GeneralOps<V, THIS>>: Timeline<V, THIS> {
   ...
   *
   * All timeline collections are required to add either [gov.nasa.ammos.plandev.procedural.timeline.ops.coalesce.CoalesceNoOp] or
   * [gov.nasa.ammos.plandev.procedural.timeline.ops.coalesce.CoalesceSegmentsOp] to satisfy this requirement.
   *
