...
import gov.nasa.jpl.plandev.merlin.driver.resources.ResourceProfiles;
...
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.DatabaseException;
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.FailedInsertException;
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.FailedUpdateException;
import gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PreparedStatements;
...
import static gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PostgresParsers.discreteProfileTypeP;
import static gov.nasa.jpl.plandev.merlin.server.remotes.postgres.PostgresParsers.realProfileTypeP;
