...
import gov.nasa.jpl.plandev.scheduler.server.services.ConstraintsTypescriptCodeGenerationHelper;
...
import gov.nasa.jpl.plandev.scheduler.server.services.TypescriptCodeGenerationService;
...
public class SchedulingDSLCompilationService {
      ...
      final String expectedReturnType)
  {
    ...
    final var constraintsGeneratedCode = gov.nasa.jpl.plandev.constraints.TypescriptCodeGenerationService.generateTypescriptTypes(
