...
import gov.nasa.ammos.plandev.procedural.timeline.BoundsTransformer
import gov.nasa.ammos.plandev.procedural.timeline.Interval
import gov.nasa.ammos.plandev.procedural.timeline.Timeline
import gov.nasa.ammos.plandev.procedural.timeline.ops.NonZeroDurationOps
import gov.nasa.ammos.plandev.procedural.timeline.ops.SerialOps
import gov.nasa.ammos.plandev.procedural.timeline.ops.coalesce.CoalesceIntervalsOp
    ...
    NonZeroDurationOps<Interval, Windows>
{
   ...
   *
   * Essentially a rename of [gov.nasa.ammos.plandev.procedural.timeline.ops.GeneralOps.unset].
   */
   ...
   *
   * Unlike [gov.nasa.ammos.plandev.procedural.timeline.ops.ParallelOps.shiftEndpoints], this function
